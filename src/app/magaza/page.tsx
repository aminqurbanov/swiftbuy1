...
export default function MagazaPage() {
  ...
  if (role !== "store") {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center px-6 text-center">
        ...
        <Link
          href="/"
          className="min-h-[52px] rounded-2xl bg-blue-600 px-8 py-3.5 text-lg font-semibold text-white shadow-lg shadow-blue-600/25 transition hover:bg-blue-700"
        >
          Əsas səhifəyə qayıt
        </Link>
      </div>
  ...
  return (
    <>
      ...
      <Suspense
        fallback={
          <div className="flex min-h-[40vh] items-center justify-center text-lg text-slate-500">
            Kataloq yüklənir…
          </div>
        }
      >
