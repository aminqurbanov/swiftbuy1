...
import ManufacturersBrowse from "./ManufacturersBrowse";

export default function IstehsalchilarPage() {
      ...
      <header className="sticky top-0 z-30 border-b border-slate-200/80 bg-white/95 px-4 py-4 shadow-sm backdrop-blur-md sm:px-6">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3">
          <div className="flex flex-wrap items-center gap-3">
            <Link
              href="/magaza"
              className="text-xl font-extrabold text-slate-900 md:text-2xl"
            >
